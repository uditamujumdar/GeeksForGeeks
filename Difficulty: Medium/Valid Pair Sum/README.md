<h2><a href="https://www.geeksforgeeks.org/problems/valid-pair-sum--141631/1?page=2&category=Greedy&difficulty=Medium,Hard&sortBy=submissions">Valid Pair Sum</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array of size <strong>N</strong>, find the number of distinct pairs <strong>{i, j} (i != j)</strong>&nbsp;in the array such that the sum of <strong>a[i]</strong> and <strong>a[j]</strong> is greater than 0.</span></p>
